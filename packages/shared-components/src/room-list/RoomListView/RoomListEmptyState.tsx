...
export const RoomListEmptyState: React.FC<RoomListEmptyStateProps> = ({ vm }): JSX.Element => {
    ...
    // Handle different filter cases based on filter name
    const filterName = activeFilter.name;

    switch (filterName) {
        case _t("room_list|filters|favourite"):
            return (
                <GenericPlaceholder
        ...
        case _t("room_list|filters|people"):
            return (
                <GenericPlaceholder
        ...
        case _t("room_list|filters|rooms"):
            return (
                <GenericPlaceholder
        ...
        case _t("room_list|filters|unread"):
            return (
                <ActionPlaceholder
        ...
        case _t("room_list|filters|invites"):
            return (
                <ActionPlaceholder
        ...
        case _t("room_list|filters|mentions"):
            return (
                <ActionPlaceholder
        ...
        case _t("room_list|filters|low_priority"):
            return (
                <ActionPlaceholder
